  ...
  services: {
    ...
    firebase: {
      serviceAccountObject: {
        'type': process.env.FSAV_TYPE,
        'project_id': process.env.FSAV_PROJECT_ID,
        'private_key_id': process.env.FSAV_PRIVATE_KEY_ID,
        'private_key': process.env.FSAV_PRIVATE_KEY,
        'client_email': process.env.FSAV_CLIENT_EMAIL,
        'client_id': process.env.FSAV_CLIENT_ID,
        'auth_uri': process.env.FSAV_AUTH_URI,
        'token_uri': process.env.FSAV_TOKEN_URI,
        'auth_provider_x509_cert_url': process.env.FSAV_AUTH_PROVIDER_X509_CERT_URL,
        'client_x509_cert_url':process.env.FSAV_CLIENT_X509_CERT_URL
      },
    }
  },
  aggregator: {
